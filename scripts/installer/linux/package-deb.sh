...
APP_DIR="$STAGE/usr/lib/$PACKAGE_NAME"
...
install -m 0755 "$ROOT/target/release/codex-plus-plus" "$APP_DIR/codex-plus-plus"
install -m 0755 "$ROOT/target/release/codex-plus-plus-manager" "$APP_DIR/codex-plus-plus-manager"
